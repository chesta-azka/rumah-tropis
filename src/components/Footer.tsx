        ...
        <footer className="bg-bark-deeper pt-16 pb-8 px-6 border-t border-gold/10">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-14">
                    ...
                    {/* Contact - Updated from source */}
                    <div>
                        <div className="text-cream/35 text-xs tracking-[0.2em] uppercase mb-5">Kontak & Alamat</div>
                            <div className="space-y-4">
                                    {/* Alamat Lengkap */}
                                            <div className="flex items-start gap-3">
                                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#B88A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-0.5 flex-shrink-0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                                                    <span className="text-cream/55 text-sm leading-relaxed">
                                                                                    [span_1](start_span)Eightyeight @Kasablanka Office Tower A Lantai 26 Unit F,[span_1](end_span) <br />
                                                                                                    Jl. Casablanca Raya No.Kav. 88, Menteng Dalam, Kec. [span_2](start_span)Tebet,[span_2](end_span) <br />
                                                                                                                    [span_3](start_span)Jakarta Selatan, 12870[span_3](end_span)
                                                                                                                                </span>
                                                                                                                                        </div>
                                                                                                                                                
                                                                                                                                                        {/* WhatsApp */}
                                                                                                                                                                <div className="flex items-center gap-3">
                                                                                                                                                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#B88A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                                                                                                                                                                                        [span_4](start_span)<span className="text-cream/55 text-sm">+62 813-8969-965[span_4](end_span)</span>
                                                                                                                                                                                                </div>
                                                                                                                                                                                                        
                                                                                                                                                                                                                {/* Email */}
                                                                                                                                                                                                                        <div className="flex items-center gap-3">
                                                                                                                                                                                                                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#B88A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                                                                                                                                                                                                                                [span_5](start_span)<span className="text-cream/55 text-sm">hello@rumahtropis.co.id[span_5](end_span)</span>
                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                            </div>
