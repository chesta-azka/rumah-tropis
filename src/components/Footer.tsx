        ...
        <footer className="bg-bark-deeper pt-16 pb-8 px-6 border-t border-gold/10">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-14">
                    ...
                    {/* Kolom Kontak & Alamat */}
                    <div>
                        [span_0](start_span)<h4 className="text-[#F5F2ED]/30 text-xs font-bold tracking-[0.2em] uppercase mb-6">Kontak & Alamat[span_0](end_span)</h4>
                                    ...
                                    {/* Alamat Resmi */}
                                            <div className="flex items-start gap-4">
                                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#B88A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-1 flex-shrink-0">
                                                                        [span_1](start_span)<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />[span_1](end_span)
                                                                                        [span_2](start_span)<circle cx="12" cy="10" r="3" />[span_2](end_span)
                                                                                                    </svg>
                                                                                                                <p className="text-[#F5F2ED]/60 text-sm leading-relaxed">
                                                                                                                                Eightyeight @Kasablanka Office Tower A Lantai 26 Unit F, Jl. Casablanca Raya No.Kav. 88, Menteng Dalam, Kec. [span_3](start_span)Tebet, Jakarta Selatan, 12870[span_3](end_span)
                                                                                                                                            </p>
                                                                                                                                                    </div>
                                                                                                                                                            ...
                                                                                                                                                            {/* WhatsApp Resmi */}
                                                                                                                                                                    <div className="flex items-center gap-4">
                                                                                                                                                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#B88A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0">
                                                                                                                                                                                                [span_4](start_span)<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />[span_4](end_span)
                                                                                                                                                                                                            </svg>
                                                                                                                                                                                                                        <span className="text-[#F5F2ED]/60 text-sm">
                                                                                                                                                                                                                                        [span_5](start_span)+62 813-8969-965[span_5](end_span)
                                                                                                                                                                                                                                                    </span>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    {/* Email Resmi */}
                                                                                                                                                                                                                                                                            <div className="flex items-center gap-4">
                                                                                                                                                                                                                                                                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#B88A6E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0">
                                                                                                                                                                                                                                                                                                        [span_6](start_span)<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />[span_6](end_span)
                                                                                                                                                                                                                                                                                                                        [span_7](start_span)<polyline points="22,6 12,13 2,6" />[span_7](end_span)
                                                                                                                                                                                                                                                                                                                                    </svg>
                                                                                                                                                                                                                                                                                                                                                <span className="text-[#F5F2ED]/60 text-sm">
                                                                                                                                                                                                                                                                                                                                                                [span_8](start_span)hello@rumahtropis.co.id[span_8](end_span)
                                                                                                                                                                                                                                                                                                                                                                            </span>
                                                                                                                                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                        </div>
