        ...
        <footer className="bg-bark-deeper pt-16 pb-8 px-6 border-t border-gold/10">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-14">
                    ...
                    {/* Contact */}
                    <div>
                        <div className="text-cream/35 text-xs tracking-[0.2em] uppercase mb-5">Kontak</div>
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-cream/55 text-sm">+62 812 3456 7890</span>
                            </div>
                            <div className="flex items-center gap-3">
                                {/* Mail Manual SVG */}
                                ...
                                <span className="text-cream/55 text-sm">halo@rumahtropis.id</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-cream/25 text-xs">
                        © 2024 Rumah Tropis. Hak cipta dilindungi.
                    </p>
