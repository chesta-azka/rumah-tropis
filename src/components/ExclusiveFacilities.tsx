  ...
  const getHeaders = () => {
    if (activeTemplate === "arsitetika-studio") {
      return {
        ...
        subtitle: "Layanan premium komprehensif untuk mengamankan mutu fisik dan finansial aset properti Anda dari hulu hingga hilir."
      };
    }
    if (activeTemplate === "akademicrypto") {
      return {
        ...
        <div className="space-y-24 max-w-5xl mx-auto">
          {facilities.map((fac, idx) => {
            ...
            return (
              <div 
                key={fac.id}
                className={`grid lg:grid-cols-12 gap-8 lg:gap-12 items-center p-6 md:p-10 rounded-3xl border border-white/5 bg-[#09090C] transition-all duration-500 hover:border-white/10 shadow-2xl relative group`}
              >
                ...
                <div className={`space-y-6 lg:col-span-6 ${isEven ? "lg:order-2" : ""}`}>
