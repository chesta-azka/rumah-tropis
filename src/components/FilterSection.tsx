    ...
    <section id="kualifikasi" className="py-16 border-b border-white/[0.03] relative" style={{ backgroundColor: theme.bg }}>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20 max-w-4xl mx-auto space-y-4">
          ...
          {activeTemplate === "arsitetika-studio" ? (
            <h2 
              className="text-white font-sans font-black text-2xl sm:text-3xl md:text-[36px] uppercase tracking-tight leading-[1.2] max-w-3xl mx-auto"
              style={{ fontFamily: theme.fontTitle }}
            >
              Sebelum Melangkah Lebih Jauh, Pastikan{" "}
              <span className="block mt-2 tracking-tight transition-all duration-300 bg-clip-text text-transparent bg-gradient-to-r from-[#B88A6E] via-[#F5E6D3] to-[#FEF9ED]">
                Rumah Tropis Adalah Partner yang Tepat untuk Investasi Properti Ini
              </span>
            </h2>
          ) : (
        ...
        {/* BOTTOM CALL TO ACTION ROW - HIDDEN FOR ARSITETIKA-STUDIO */}
        {activeTemplate !== "arsitetika-studio" && (
          <div className="text-center relative max-w-2xl mx-auto space-y-6 pt-16">
