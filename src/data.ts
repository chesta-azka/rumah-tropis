...
export const templates: Record<string, TemplateData> = {
  ...
  "arsitetika-studio": {
    ...
    portfolioItems: [
      {
        id: "p1",
        path: "/images/portfolio/the-licieuse-eatery.webp",
        title: "The Licieuse Coffee & Eatery",
        location: "Jakarta Selatan",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (Premium Lossy Profile)",
        fileSize: "142 KB",
        styleTheme: "Tropical Commercial Fusion",
        keyMaterials: ["Clay Bricks / Roster", "Copper-Bronze Trims", "Backlit Brass Signage"],
        designStory: "Proyek komersial-residensial eksklusif bergaya Tropis Modern yang mengedepankan sirkulasi udara bersih, pencahayaan alami tak langsung, serta facade megah bertabur pendaran lampu warm hangat 2700K."
      },
      {
        id: "p2",
        path: "/images/portfolio/d37-cubic-villa.webp",
        title: "D3-7 Cubic Tropical Villa",
        location: "Uluwatu, Bali",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (Ultra Low Latency Web)",
        fileSize: "115 KB",
        styleTheme: "Contemporary Minimalist Cubic",
        keyMaterials: ["White Lime Stucco", "Vertical Teak Slats", "Concrete Ventilation blocks"],
        designStory: "Vila privat minimalis dengan penataan kubus asimetris yang menyeimbangkan kehangatan bilah jati alam berpadu dengan ketegasan beton ekspos serta sirkulasi silang optimal."
      },
      {
        id: "p3",
        path: "/images/portfolio/layered-teak-residence.webp",
        title: "The Layered Teak Residence",
        location: "Ciumbuleuit, Bandung",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (High Density)",
        fileSize: "135 KB",
        styleTheme: "Organic Modernist Luxury",
        keyMaterials: ["Basalt Stone Slats", "Crafted Solid Teak Door", "Tempered Flat Glass Row"],
        designStory: "Hunian premium di lereng beriklim sejuk, memadukan pintu jati berpola geometri tiga dimensi yang rumit dengan pilar kokoh batuan andesit dan penutup panel kayu hangat."
      },
      {
        id: "p4",
        path: "/images/portfolio/minimalist-asymmetric-25.webp",
        title: "Asymmetric Pavilion No. 25",
        location: "Canggu, Bali",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (High Precision)",
        fileSize: "108 KB",
        styleTheme: "Warm Minimalist Pavilion",
        keyMaterials: ["Slanted Concrete Canopy", "Natural Cedar Panels", "Custom Flat Wood Sliding Gate"],
        designStory: "Satu lantai kenyamanan murni dengan atap asimetris bertingkat tunggal, dinding stucco putih bersih dibingkai oleh lansekap taman liar dan gerbang geser bertekstur serat kayu horizontal."
      },
      {
        id: "p5",
        path: "/images/portfolio/brutalist-gable-villa.webp",
        title: "The Brutalist Gable Villa",
        ...
        keyMaterials: ["Board-formed Reinforced Concrete", "Ironwood Cladding", "Recessed Tall Glass Slots"],
        designStory: "Mengawinkan keteguhan struktur beton cetak beralur papan kayu dengan kehangatan pelapis kayu besi (kayu ulin) tahan cuaca ekstrem pada puncak gables bergaya lumbung modern."
      },
      {
        id: "p6",
        path: "/images/portfolio/recessed-lines-mansion-a1.webp",
        title: "Recessed Lines Mansion A1",
        location: "Menteng, Jakarta Barat",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (High Density Lossless)",
        fileSize: "124 KB",
        styleTheme: "Contemporary Architectural Linear",
        keyMaterials: ["Satin White Plaster", "Indirect Linear LED Outlines", "Solid Teak Pivot Door"],
        designStory: "Karya agung arsitektur linier kontemporer dengan fasad monolitik megah yang bersinar dramatis di malam hari melalui slot lampu LED tersembunyi berkedalaman khusus."
      },
      {
        id: "p7",
        path: "/images/portfolio/travertine-symmetry-100.webp",
        title: "Travertine Symmetry Palace 100",
        location: "Citraland, Surabaya",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (Studio Profile)",
        fileSize: "148 KB",
        styleTheme: "Symmetrical Tropical Luxury",
        keyMaterials: ["Sandy Travertine Tiles", "Solid Wood Privacy Screens", "Concrete Boundary Wall"],
        designStory: "Istana megah bergaya simetris tropis yang menonjolkan keunikan tekstur pori batuan pasir travertine alami impor berpadu serasi dengan pagar kayu bergaris lebar modern."
      },
      {
        id: "p8",
        path: "/images/portfolio/matted-gable-villa-15.webp",
        title: "Warm Gable Retreat No. 15",
        location: "Sanur, Bali",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (Light Profile)",
        fileSize: "96 KB",
        styleTheme: "Classic Modernist Tropical Ranch",
        keyMaterials: ["Steel Structural Overhang", "Cedar Siding Gable", "Black Metal Slitted Fence"],
        designStory: "Hunian resor satu lantai beratap gables lebar dengan kanopi besi panjang berpenampang presisi, dikelilingi taman rimbun tropis nan teduh di daerah pesisir Sanur."
      },
      {
        id: "p9",
        path: "/images/portfolio/lattice-shutters-manor.webp",
        title: "The Lattice Shutters Manor",
        location: "Dharmawangsa, Jakarta Selatan",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (Lossless High Fidelity)",
        fileSize: "159 KB",
        styleTheme: "Ornamented Screen Villa",
        keyMaterials: ["Cast Metal Filigree Screens", "Golden Sandstone Facade", "Flowing Greenery"],
        designStory: "Kombinasi eksklusif kerajinan tangan lokal berupa kisi-kisi penahan panas bermotif ukiran luhur dengan dinding batu alam kuning keemasan berselimut juraian tanaman hias menjalar."
      },
      {
        id: "p10",
        path: "/images/portfolio/planter-box-balcony-villa.webp",
        title: "The Planter Box Balcony Villa",
        location: "Ubud, Bali",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (Hyper Compressed)",
        fileSize: "132 KB",
        styleTheme: "Integrated eco-Luxury Villa",
        keyMaterials: ["Slab Limestone", "Modular Teak Louvers", "Living Shrub Railings"],
        designStory: "Vila kontemporer dua tingkat yang menanamkan alam langsung ke dalam bangunan melalui dek beton dengan pot tanaman terpadu (planter box) yang mengalirkan kesejukan ke kamar tidur lantai dua."
      },
      {
        id: "p11",
        path: "/images/portfolio/terracotta-breeze-carport.webp",
        title: "The Terracotta Breeze Carport",
        location: "Kemang, Jakarta",
        dimensions: "1080 x 1350 px",
        aspectRatio: "4:5 Portrait",
        fileFormat: "WEBP (Ultra Light Web)",
        fileSize: "110 KB",
        styleTheme: "Screed Industrial Tropical",
        keyMaterials: ["Terracotta Breeze Loster", "Rough Screed Plaster", "Integrated Ceiling Slats"],
        designStory: "Menampilkan estetika sudut parkir carport modern beraura hangat melalui dinding bata losen merah terracotta berlubang penapis sinar matahari berpadu dengan lantai plester beton halus."
      }
    ],
